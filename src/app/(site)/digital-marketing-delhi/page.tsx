...
export const metadata: Metadata = {
  title: 'Digital Marketing in Delhi | BROSAVO',
  description: 'BROSAVO provides digital marketing in Delhi focused on SEO, local search, content and conversion strategies for growing businesses.',
  alternates: { canonical: `${SITE_URL}/digital-marketing-delhi` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Digital Marketing in Delhi | BROSAVO',
    description: 'BROSAVO provides digital marketing in Delhi focused on SEO, local search, content and conversion strategies for growing businesses.',
    url: `${SITE_URL}/digital-marketing-delhi`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO combines search visibility, useful content and conversion-focused website experiences to help Delhi businesses generate more qualified opportunities.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Digital Marketing in Delhi | BROSAVO',
          description: 'BROSAVO provides digital marketing in Delhi focused on SEO, local search, content and conversion strategies for growing businesses.',
          url: `${SITE_URL}/digital-marketing-delhi`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Build a stronger digital presence in Delhi.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines search visibility, useful content and conversion-focused website experiences to help Delhi businesses generate more qualified opportunities.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines search visibility, useful content and conversion-focused website experiences to help Delhi businesses generate more qualified opportunities. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
