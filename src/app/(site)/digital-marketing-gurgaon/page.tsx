...
export const metadata: Metadata = {
  title: 'Digital Marketing in Gurgaon | BROSAVO',
  description: 'BROSAVO provides digital marketing in Gurgaon through SEO, local search, content and conversion-focused strategies designed to generate business enquiries.',
  alternates: { canonical: `${SITE_URL}/digital-marketing-gurgaon` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Digital Marketing in Gurgaon | BROSAVO',
    description: 'BROSAVO provides digital marketing in Gurgaon through SEO, local search, content and conversion-focused strategies designed to generate business enquiries.',
    url: `${SITE_URL}/digital-marketing-gurgaon`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO helps Gurgaon businesses improve search visibility, strengthen their online presence and create more opportunities for qualified enquiries.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Digital Marketing in Gurgaon | BROSAVO',
          description: 'BROSAVO provides digital marketing in Gurgaon through SEO, local search, content and conversion-focused strategies designed to generate business enquiries.',
          url: `${SITE_URL}/digital-marketing-gurgaon`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Grow your Gurgaon business with a stronger digital presence.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Gurgaon businesses improve search visibility, strengthen their online presence and create more opportunities for qualified enquiries.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Gurgaon businesses improve search visibility, strengthen their online presence and create more opportunities for qualified enquiries. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
