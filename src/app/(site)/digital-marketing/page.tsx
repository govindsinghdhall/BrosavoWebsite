...
export const metadata: Metadata = {
  title: 'Digital Marketing Services | BROSAVO',
  description: 'BROSAVO provides digital marketing services focused on search visibility, lead generation, content, local presence and measurable business growth.',
...
const faqs = [
  {
    ...
    answer: 'BROSAVO combines SEO, content, local search and conversion-focused digital strategies to help growing businesses build a stronger online presence.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Digital Marketing Services | BROSAVO',
          description: 'BROSAVO provides digital marketing services focused on search visibility, lead generation, content, local presence and measurable business growth.',
          url: `${SITE_URL}/digital-marketing`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Digital marketing focused on visibility, leads and growth.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines SEO, content, local search and conversion-focused digital strategies to help growing businesses build a stronger online presence.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines SEO, content, local search and conversion-focused digital strategies to help growing businesses build a stronger online presence. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
