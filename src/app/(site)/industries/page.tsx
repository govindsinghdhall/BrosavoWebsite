...
export const metadata: Metadata = {
  title: 'Industries We Serve | BROSAVO',
  description: 'Explore BROSAVO digital solutions for real estate, realtors, property consultants, developers, brokers and other growing businesses.',
...
const faqs = [
  {
    ...
    answer: 'BROSAVO develops websites, CRM and lead management solutions around the workflows and customer journeys of specific industries.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Industries We Serve | BROSAVO',
          description: 'Explore BROSAVO digital solutions for real estate, realtors, property consultants, developers, brokers and other growing businesses.',
          url: `${SITE_URL}/industries`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Digital solutions built around how businesses actually operate.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO develops websites, CRM and lead management solutions around the workflows and customer journeys of specific industries.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO develops websites, CRM and lead management solutions around the workflows and customer journeys of specific industries. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
