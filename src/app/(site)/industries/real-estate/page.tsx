...
export const metadata: Metadata = {
  title: 'Real Estate Digital Solutions | BROSAVO',
  description: 'BROSAVO provides websites, real estate CRM, lead management and digital marketing solutions for real estate businesses.',
  alternates: { canonical: `${SITE_URL}/industries/real-estate` },
...
const faqs = [
  {
    ...
    answer: 'BROSAVO helps real estate businesses connect their website, lead management, CRM, property workflows and digital marketing.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Real Estate Digital Solutions | BROSAVO',
          description: 'BROSAVO provides websites, real estate CRM, lead management and digital marketing solutions for real estate businesses.',
          url: `${SITE_URL}/industries/real-estate`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps real estate businesses connect their website, lead management, CRM, property workflows and digital marketing. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
