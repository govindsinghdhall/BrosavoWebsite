...
export const metadata: Metadata = {
  title: 'Digital Solutions for Realtors | BROSAVO',
  description: 'BROSAVO helps realtors with modern websites, CRM, lead management and digital marketing designed around property sales workflows.',
  alternates: { canonical: `${SITE_URL}/industries/realtors` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Digital Solutions for Realtors | BROSAVO',
    description: 'BROSAVO helps realtors with modern websites, CRM, lead management and digital marketing designed around property sales workflows.',
    url: `${SITE_URL}/industries/realtors`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO combines website development, lead management, CRM and digital marketing to help realtors build visibility and organize sales activity.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Digital Solutions for Realtors | BROSAVO',
          description: 'BROSAVO helps realtors with modern websites, CRM, lead management and digital marketing designed around property sales workflows.',
          url: `${SITE_URL}/industries/realtors`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Technology that helps realtors manage the journey from enquiry to deal.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines website development, lead management, CRM and digital marketing to help realtors build visibility and organize sales activity.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO combines website development, lead management, CRM and digital marketing to help realtors build visibility and organize sales activity. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
