...
export const metadata: Metadata = {
  title: 'Lead Management System in Delhi | BROSAVO',
  description: 'BROSAVO builds lead management systems for Delhi businesses to organize enquiries, assign leads, manage follow-ups and track sales opportunities.',
  alternates: { canonical: `${SITE_URL}/lead-management-system-delhi` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Lead Management System in Delhi | BROSAVO',
    description: 'BROSAVO builds lead management systems for Delhi businesses to organize enquiries, assign leads, manage follow-ups and track sales opportunities.',
    url: `${SITE_URL}/lead-management-system-delhi`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO helps Delhi businesses bring lead capture, ownership, follow-ups and sales pipeline management into one connected workflow.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Lead Management System in Delhi | BROSAVO',
          description: 'BROSAVO builds lead management systems for Delhi businesses to organize enquiries, assign leads, manage follow-ups and track sales opportunities.',
          url: `${SITE_URL}/lead-management-system-delhi`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            <span className="inline-flex rounded-full border border-accent-blue/20 bg-accent-blue/5 px-3.5 py-1.5 text-[10px] font-medium uppercase tracking-[0.22em] text-accent-blue">
              Lead Management in Delhi
            </span>
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Organize your sales leads with a structured system.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Delhi businesses bring lead capture, ownership, follow-ups and sales pipeline management into one connected workflow.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Delhi businesses bring lead capture, ownership, follow-ups and sales pipeline management into one connected workflow. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
