...
export const metadata: Metadata = {
  title: 'Lead Management System in Gurgaon | BROSAVO',
  description: 'BROSAVO builds lead management systems for Gurgaon businesses to capture, assign, track and follow up with sales enquiries more efficiently.',
  alternates: { canonical: `${SITE_URL}/lead-management-system-gurgaon` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Lead Management System in Gurgaon | BROSAVO',
    description: 'BROSAVO builds lead management systems for Gurgaon businesses to capture, assign, track and follow up with sales enquiries more efficiently.',
    url: `${SITE_URL}/lead-management-system-gurgaon`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'Centralize enquiries, assign ownership and give your sales team a consistent process for managing opportunities from first contact to conversion.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Lead Management System in Gurgaon | BROSAVO',
          description: 'BROSAVO builds lead management systems for Gurgaon businesses to capture, assign, track and follow up with sales enquiries more efficiently.',
          url: `${SITE_URL}/lead-management-system-gurgaon`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            <span className="inline-flex rounded-full border border-accent-blue/20 bg-accent-blue/5 px-3.5 py-1.5 text-[10px] font-medium uppercase tracking-[0.22em] text-accent-blue">
              Lead Management in Gurgaon
            </span>
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              A clearer lead workflow for Gurgaon businesses.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              Centralize enquiries, assign ownership and give your sales team a consistent process for managing opportunities from first contact to conversion.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              Centralize enquiries, assign ownership and give your sales team a consistent process for managing opportunities from first contact to conversion. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
