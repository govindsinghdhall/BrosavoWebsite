...
export const metadata: Metadata = {
  title: 'Lead Management System | BROSAVO',
  description: 'BROSAVO develops lead management systems that help businesses capture, organize, assign and follow up with leads from one central platform.',
  alternates: { canonical: `${SITE_URL}/lead-management-system` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Lead Management System | BROSAVO',
    description: 'BROSAVO develops lead management systems that help businesses capture, organize, assign and follow up with leads from one central platform.',
    url: `${SITE_URL}/lead-management-system`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO builds lead management systems that centralize enquiries, ownership, follow-ups, pipeline stages and customer information.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Lead Management System | BROSAVO',
          description: 'BROSAVO develops lead management systems that help businesses capture, organize, assign and follow up with leads from one central platform.',
          url: `${SITE_URL}/lead-management-system`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Turn incoming leads into a structured sales workflow.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO builds lead management systems that centralize enquiries, ownership, follow-ups, pipeline stages and customer information.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO builds lead management systems that centralize enquiries, ownership, follow-ups, pipeline stages and customer information. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
