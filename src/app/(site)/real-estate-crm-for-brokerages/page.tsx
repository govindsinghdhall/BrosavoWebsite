...
const config: PageConfig = {
  "title": "Real Estate CRM for Brokerages & Teams | Brosavo",
  "description": "Brosavo real estate CRM helps brokerages manage agents, leads, property inventory, assignments, follow-ups and performance.",
  "eyebrow": "CRM for Brokerages",
  "heading": "A centralized CRM for modern real estate brokerages.",
  "intro": "Give your brokerage a shared system for lead distribution, property inventory, sales pipelines, follow-ups and team performance.",
  "audience": "",
  "primaryKeywords": [
    "Brokerage CRM",
    "Agent Management",
  ...
  "sections": [
    {
      "title": "Manage a multi-agent sales operation",
      "paragraphs": [
        "Brokerages need visibility across agents, leads, properties and opportunities. Brosavo provides a connected workspace for these workflows."
      ],
      "bullets": [
        "Team collaboration",
        "Lead ownership",
    ...
    {
      "title": "Measure pipeline and team performance",
      "paragraphs": [
        "Track pipeline activity and understand where opportunities are progressing or getting stuck."
      ],
      "bullets": [
        "Pipeline analytics",
        "Conversion tracking",
  ...
  "faqs": [
    {
      "question": "What is a CRM for a real estate brokerage?",
      "answer": "It is software that helps a brokerage manage agents, leads, customers, properties, opportunities and sales activity in one system."
    },
    {
      "question": "Can Brosavo support teams?",
      "answer": "Yes. Professional and Enterprise capabilities support team collaboration, assignments, permissions and analytics."
    }
  ]
};
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/real-estate-crm-for-brokerages`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: config.title,
    description: config.description,
    url: `${SITE_URL}/real-estate-crm-for-brokerages`,
    type: "website",
  },
};
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl rounded-3xl border border-border/70 bg-background p-8 sm:p-12">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Open CRM for brokerage operations
              </Link>
