...
const config: PageConfig = {
  ...
  "sections": [
    {
      "title": "Manage clients and property interests together",
      "paragraphs": [
        "A realtor's workflow often spans customer requirements, property searches, conversations and repeated follow-ups. Brosavo connects these activities in one CRM."
      ],
      "bullets": [
        "Client records",
        "Property interests",
    ...
    {
      "title": "Build a repeatable sales process",
      "paragraphs": [
        "Use structured pipeline stages and tasks to make your sales process easier to manage and measure."
      ],
      "bullets": [
        "Qualification",
        "Follow-up",
  ...
  "faqs": [
    ...
    },
    {
      ...
      "answer": "Yes. Brosavo includes property inventory management and property matching workflows."
    }
  ]
};
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/real-estate-crm-for-realtors`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: config.title,
    description: config.description,
    url: `${SITE_URL}/real-estate-crm-for-realtors`,
    type: "website",
  },
};
