...
const config: PageConfig = {
  ...
  "description": "See Brosavo real estate CRM pricing for agents, teams and growing brokerages, including Starter, Professional and Enterprise options.",
  "eyebrow": "Real Estate CRM Pricing",
  "heading": "Real estate CRM pricing that scales with your business.",
  "intro": "Brosavo offers real estate CRM plans for individual agents, growing teams, brokerages and larger organizations. Start small and expand as your sales operation grows.",
  "audience": "",
  "primaryKeywords": [
    "₹999 Starter Plan",
  ...
  "faqs": [
    {
      ...
      "answer": "Brosavo Starter costs ₹999 per month, Professional costs ₹2,499 per month and Enterprise pricing is customized."
    },
    {
