...
export const REAL_ESTATE_CRM_FAQS = [
  {
    ...
    answer:
      "A real estate CRM is software that helps agents, brokers and agencies manage leads, customers, property inventory, follow-ups and sales opportunities from one platform. Instead of spreading work across spreadsheets and chat threads, Brosavo keeps the sales workflow in one place so your team can qualify enquiries, match listings and close deals with a clear next action.",
  },

  {
    question: "How does Brosavo help real estate agents?",
    answer:
      "Brosavo helps agents capture website and WhatsApp enquiries, organize customer requirements, manage property inventory and move opportunities through a sales pipeline. Follow-ups, tasks and reporting sit next to each lead, so agents spend less time hunting for context and more time converting prospects into site visits and closed deals.",
  },

  {
    question: "What are the Brosavo pricing options?",
    answer:
