...
export const metadata: Metadata = {
  title: "Real Estate Website for Agents | Brosavo",
  description: "Professional real estate websites for agents with property listings, enquiry capture and CRM-connected workflows.",
  alternates: { canonical: `${SITE_URL}/real-estate-website-for-agents` },
  openGraph: {
    title: "Real Estate Website for Agents | Brosavo",
    description: "Professional real estate websites for agents with property listings, enquiry capture and CRM-connected workflows.",
    url: `${SITE_URL}/real-estate-website-for-agents`,
    type: "website",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Real Estate Website for Agents",
  description: "Professional real estate websites for agents with property listings, enquiry capture and CRM-connected workflows.",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Build a real estate website for real estate agents that turns property traffic into enquiries.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              Professional real estate websites for agents with property listings, enquiry capture and CRM-connected workflows.
            </p>
