...
export const metadata: Metadata = {
  title: "Real Estate Website for Brokers & Brokerages | Brosavo",
  description: "Real estate websites for brokers and brokerages with property listings, lead capture, team workflows and CRM integration.",
  alternates: { canonical: `${SITE_URL}/real-estate-website-for-brokers` },
  openGraph: {
    title: "Real Estate Website for Brokers & Brokerages | Brosavo",
    description: "Real estate websites for brokers and brokerages with property listings, lead capture, team workflows and CRM integration.",
    url: `${SITE_URL}/real-estate-website-for-brokers`,
    type: "website",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Real Estate Website for Brokers & Brokerages",
  description: "Real estate websites for brokers and brokerages with property listings, lead capture, team workflows and CRM integration.",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            <span className="inline-flex rounded-full border border-accent-blue/20 bg-accent-blue/5 px-3.5 py-1.5 text-[10px] font-medium uppercase tracking-[0.22em] text-accent-blue">
              Real Estate Website for Brokers & Brokerages
            </span>
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Build a real estate website for brokers and brokerages that turns property traffic into enquiries.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              Real estate websites for brokers and brokerages with property listings, lead capture, team workflows and CRM integration.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <Link href="/real-estate-crm-for-brokers" className="rounded-full border border-border/70 bg-background px-6 py-3.5 text-sm font-medium transition hover:-translate-y-0.5">
                Explore CRM for Brokers
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl rounded-3xl bg-foreground p-8 text-background sm:p-12">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/real-estate-crm-for-brokers" className="rounded-full bg-background px-6 py-3.5 text-center text-sm font-medium text-foreground">
                Explore CRM for Brokers
              </Link>
