...
export const metadata: Metadata = {
  title: "Real Estate Website for Developers | Brosavo",
  description: "Project-focused real estate websites for developers with property information, enquiry capture and CRM-connected sales workflows.",
  alternates: { canonical: `${SITE_URL}/real-estate-website-for-developers` },
  openGraph: {
    title: "Real Estate Website for Developers | Brosavo",
    description: "Project-focused real estate websites for developers with property information, enquiry capture and CRM-connected sales workflows.",
    url: `${SITE_URL}/real-estate-website-for-developers`,
    type: "website",
  },
};
...
const serviceSchema = {
  ...
  "@type": "Service",
  name: "Real Estate Website for Developers",
  description: "Project-focused real estate websites for developers with property information, enquiry capture and CRM-connected sales workflows.",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Build a real estate website for real estate developers that turns property traffic into enquiries.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              Project-focused real estate websites for developers with property information, enquiry capture and CRM-connected sales workflows.
            </p>
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <Link href="/real-estate-crm-for-developers" className="rounded-full border border-border/70 bg-background px-6 py-3.5 text-sm font-medium transition hover:-translate-y-0.5">
                Explore CRM for Developers
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl rounded-3xl bg-foreground p-8 text-background sm:p-12">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <Link href="/real-estate-crm-for-developers" className="rounded-full bg-background px-6 py-3.5 text-center text-sm font-medium text-foreground">
                Explore CRM for Developers
              </Link>
