...
export const metadata: Metadata = {
  title: 'Website Development in Gurgaon | BROSAVO',
  description: 'BROSAVO provides website development in Gurgaon for businesses that need modern, responsive, SEO-ready websites designed to generate enquiries.',
  alternates: { canonical: `${SITE_URL}/website-development-gurgaon` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Website Development in Gurgaon | BROSAVO',
    description: 'BROSAVO provides website development in Gurgaon for businesses that need modern, responsive, SEO-ready websites designed to generate enquiries.',
    url: `${SITE_URL}/website-development-gurgaon`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO helps Gurgaon businesses build modern websites that communicate their value clearly, improve online visibility and turn visitors into enquiries.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Website Development in Gurgaon | BROSAVO',
          description: 'BROSAVO provides website development in Gurgaon for businesses that need modern, responsive, SEO-ready websites designed to generate enquiries.',
          url: `${SITE_URL}/website-development-gurgaon`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Professional website development for businesses in Gurgaon.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Gurgaon businesses build modern websites that communicate their value clearly, improve online visibility and turn visitors into enquiries.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO helps Gurgaon businesses build modern websites that communicate their value clearly, improve online visibility and turn visitors into enquiries. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
