...
export const metadata: Metadata = {
  title: 'Website Development in Noida | BROSAVO',
  description: 'BROSAVO develops modern, responsive and SEO-ready websites for businesses in Noida, with clear messaging and conversion-focused design.',
  alternates: { canonical: `${SITE_URL}/website-development-noida` },
  robots: { index: true, follow: true },
  openGraph: {
    title: 'Website Development in Noida | BROSAVO',
    description: 'BROSAVO develops modern, responsive and SEO-ready websites for businesses in Noida, with clear messaging and conversion-focused design.',
    url: `${SITE_URL}/website-development-noida`,
    type: "website",
  },
};
...
const faqs = [
  {
    ...
    answer: 'BROSAVO builds modern websites that help Noida businesses present their services professionally and create a stronger path from search to enquiry.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Website Development in Noida | BROSAVO',
          description: 'BROSAVO develops modern, responsive and SEO-ready websites for businesses in Noida, with clear messaging and conversion-focused design.',
          url: `${SITE_URL}/website-development-noida`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              High-quality website development for Noida businesses.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO builds modern websites that help Noida businesses present their services professionally and create a stronger path from search to enquiry.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO builds modern websites that help Noida businesses present their services professionally and create a stronger path from search to enquiry. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
