...
export const metadata: Metadata = {
  title: 'Website Development Services | BROSAVO',
  description: 'BROSAVO builds fast, responsive and conversion-focused websites for growing businesses with modern design, SEO and scalable technology.',
...
const faqs = [
  {
    ...
    answer: 'BROSAVO designs and develops modern business websites combining user experience, responsive performance, SEO-ready architecture and clear conversion paths.',
  },
  {
    ...
    <main>
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "WebPage",
          name: 'Website Development Services | BROSAVO',
          description: 'BROSAVO builds fast, responsive and conversion-focused websites for growing businesses with modern design, SEO and scalable technology.',
          url: `${SITE_URL}/website-development`,
          publisher: {
            "@type": "Organization",
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight tracking-[-0.05em] sm:text-5xl lg:text-6xl">
              Websites built to help growing businesses compete online.
            </h1>
            <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-muted sm:text-lg">
              BROSAVO designs and develops modern business websites combining user experience, responsive performance, SEO-ready architecture and clear conversion paths.
            </p>
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="mt-6 text-base leading-8 text-muted sm:text-lg">
              BROSAVO designs and develops modern business websites combining user experience, responsive performance, SEO-ready architecture and clear conversion paths. BROSAVO focuses on clear information architecture, useful customer journeys and technology that can support future growth.
            </p>
          </div>
        </div>
      </section>
