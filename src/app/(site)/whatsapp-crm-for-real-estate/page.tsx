...
const config: PageConfig = {
  ...
  "intro": "Use WhatsApp engagement workflows alongside your CRM so important customer conversations stay connected to leads and opportunities.",
  "audience": "",
  "primaryKeywords": [
    "WhatsApp CRM",
  ...
  "sections": [
    {
      "title": "Connect conversations with customer records",
      "paragraphs": [
        "Real estate conversations often contain important requirements, questions and follow-up context. Brosavo helps keep engagement connected to the sales workflow."
      ],
      "bullets": [
    ...
    {
      "title": "Use WhatsApp as part of the sales process",
      "paragraphs": [
        "Professional plans include WhatsApp API integration for teams that need deeper communication workflows."
      ],
      "bullets": [
        "WhatsApp API",
  ...
  "faqs": [
    {
      ...
      "answer": "Yes. Starter includes WhatsApp notifications while Professional includes WhatsApp API integration."
    },
    {
      "question": "Is WhatsApp API included in every plan?",
      "answer": "WhatsApp API integration is included in the Professional plan; Starter includes WhatsApp notifications."
    }
  ]
};
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: `${SITE_URL}/whatsapp-crm-for-real-estate`,
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    title: config.title,
    description: config.description,
    url: `${SITE_URL}/whatsapp-crm-for-real-estate`,
    type: "website",
  },
};
        ...
        <div className="container-wide px-6 lg:px-10">
          <div className="mx-auto max-w-4xl rounded-3xl border border-border/70 bg-background p-8 sm:p-12">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              >
                See the full Real Estate CRM platform
              </Link>
